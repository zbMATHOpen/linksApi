...
object_id_info = api.model(
    "identifier", {
        "ID": fields.String(
            readOnly=True,
            description="The unique identifier the object"
        ),
        ...
        "IDURL": fields.String(
            description="web address of the object"
        )
    }
)
...
name_model = api.model(
    "name", {
        ...
        "Subtype": fields.String(
            required=True,
            description="MSC codes"
        )
    }
)

name_model_creator = api.model(
    "name", {
        "Name": fields.String(required=True)
    }
)
...
publisher_model = api.model(
    "publisher", {
        "Name": fields.String(
            required=True,
            description="name of the zbMATH partner"
        ),
        "Identifier": fields.Nested(object_id_info)
    }
)
...
source = api.model(
    "source", {
        ...
        "Title": fields.String(
            required=False,
            description="Title of section where link arises"
        ),
...
target = api.model(
    "target", {
        ...
        "Creator": fields.List(
            fields.Nested(name_model_creator)
        ),
...
link = api.model(
    "link to zbMATH", {
        ...
        "LinkPublicationDate": fields.DateTime(
            required=True,
            description="Date the link was established"
        ),
